...
#    from modules.pm import generate_photomaker
    ...
    def process_task(all_steps, async_task, callback, controlnet_canny_path, controlnet_cpds_path, current_task_id,
        ...
        if async_task.inswapper_enabled:
            imgs = perform_face_swap(imgs, async_task.inswapper_source_image, async_task.inswapper_source_image_indicies, async_task.inswapper_target_image_indicies, async_task.codeformer_enabled,async_task.codeformer_fidelity,async_task.codeformer_alpha,async_task.exclude_mouth)
